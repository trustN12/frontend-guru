...
import { ArrowRight, Code, Layout, Lightbulb, CheckCircle, Zap, BookOpen } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-xl text-pretty">
                Elevate your frontend skills with Nabarun Biswas, learning JavaScript, React, and modern UI libraries through practical, real-world applications.
              </p>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gradient-to-tr from-primary/5 to-primary/20 rounded-2xl p-6 md:p-8 overflow-hidden">
                <div className="glass-card rounded-lg p-4 md:p-6 shadow-lg">
                  <div className="mb-6">
    ...
    >
      ...
      <p className="description">{desc}</p>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-mono text-muted-foreground">From React Mastery Course</span>
          ...
          <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">
                Access unique insights and techniques not available on YouTube or other platforms.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">
                Build real-world projects that demonstrate modern frontend engineering practices.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">
                Learn the latest frameworks and libraries like React, Tailwind CSS, and modern UI libraries.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">
                Get comprehensive training for technical interviews, with real questions and expert feedback.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">
                Master frontend system design principles essential for senior engineering roles.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">Personalized Mentoring</h3>
              <p className="text-muted-foreground text-sm">
                Receive one-on-one guidance tailored to your specific learning needs and career goals.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <CourseCard
              ...
              topics={["Algorithms", "System Design", "Behavioral", "Take-home"]}
            />
            ...
            <CourseCard
              ...
              topics={["Architecture", "Performance", "State Management", "API Design"]}
            />
            ...
            <CourseCard
              ...
              topics={["Autocomplete", "Infinite Scroll", "Kanban Board", "Form Builder"]}
            />
          </div>
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            >
              Whether you're just starting out or looking to level up your career, I can help you master the skills that modern employers demand.
            </motion.p>
